...
<head>
    <meta charset="UTF-8">
    <title>Union Eleições - Lista de Chamada</title>
...
<body>
    ...
    <main>
        <table>
            ...
            <tbody>
                @forelse ($listaDeChamadas as $listaDaChamada)
                    <tr>
                        <td>{{ $listaDaChamada->lista_chamada_id }}</td>
                        <td>{{ $listaDaChamada->nome }}</td>
                        <td>{{ formatarCpfCnpj($listaDaChamada->cpf_cnpj) }}</td>
                        <td>{{ $listaDaChamada->email }}</td>
                        <td>{{ formatarTelefone($listaDaChamada->celular) }}</td>
                        <td>
