        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Celular</th>
                    <th>Atualizado</th>
                    <th>Recuperou Senha</th>
                    <th>Troca Senha</th>
                    <th>Status</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($listaDeEleitores as $listaDeEleitor)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $listaDeEleitor->nome }}</td>
                        <td>{{ formatarCpfCnpj($listaDeEleitor->cpf_cnpj) }}</td>
                        <td>{{ $listaDeEleitor->email }}</td>
                        <td>{{ formatarTelefone($listaDeEleitor->celular) }}</td>
                        <td>
