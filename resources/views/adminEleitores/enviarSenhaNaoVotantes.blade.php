...
@section('title', 'Union Eleições - Enviar Senha para os eleitores não votates')
...
<div class="container">
    <div class="container-fluid">
        ...
        <!-- Cabeçalho -->
        <div class="mb-5">
            <h1 class="h2 fw-bolder text-dark">Enviar Senha para os eleitores não votates</h1>
            <p class="text-muted mt-1">
                Clique no botão abaixo para gerar e enviar a senha de acesso para todos os eleitores não votantes por e-mail e SMS.
            </p>
        </div>
        ...
        <div class="card shadow-lg border-0 rounded-3 stat-card">
            <div class="card-body p-4 p-md-5">
                ...
                <form id="formEnviarSenha" action="{{ route('admin.adminEleitores.formEnviarSenhaParaTodosNaoVotantes') }}" method="GET">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnAbortar.addEventListener('click', async function() {
        ...
        try {
            ...
            await fetch('{{ route('admin.adminEleitores.abortarEnvioNaoVotantes') }}', {
                method: 'POST',
                headers: {
