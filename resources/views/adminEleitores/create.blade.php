...
@section('title', 'Union Eleições - Novo Eleitor')

@section('content')
<div class="container">
    <!-- Cabeçalho -->
    <div class="mb-5">
        <h1 class="h2 fw-bolder text-dark">Novo Eleitor</h1>
        <p class="text-muted mt-1">
            Cadastre um novo eleitor e defina suas informações de participação na eleição.
        </p>
    </div>
    ...
    <div class="card shadow-lg border-0 rounded-3 stat-card">
        <div class="card-body p-4">
            <form action="{{ route('admin.adminEleitores.store') }}" method="POST">
                @csrf
